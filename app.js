...
const questions = [
    ...
    {
        quiz: ['nature', 'soil', 'erosion'],
        options: ['rhythm', 'sediment'],
        correct: 2
    },
    {
        quiz: ['cash', 'bonus', 'compensation'],
        options: ['incentive', 'doctrine'],
        correct: 1
    },
    {
        quiz: ['high', 'height', 'tall'],
        options: ['altitude', 'enzyme'],
        correct: 2
    },
    {
        quiz: ['monthly ', 'weekly', 'annually'],
        options: ['publicly', 'quarterly'],
        correct: 2
    },
    {
        quiz: ['aware', 'know', 'alert'],
        options: ['conscious', 'unlawful'],
        correct: 2
    }
]
